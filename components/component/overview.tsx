...
* @see https://v0.dev/t/oL7HrKsUj9p
...
interface DormitoryData {
  [dormitoryName: string]: Dormitory
}
...
export function Overview() {
  ...
  return (
    <div className=" search mx-auto sm:px-8 md:px-10">
          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                ...
                {showVisualData ? (
                  <div className="space-y-4 flex-row flex-1">
